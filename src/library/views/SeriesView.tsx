      ...
      <mui.Grid>
        <mui.Paper className={this.classes.container} square={true}>
          <mui.Tabs indicatorColor="primary" variant="fullWidth"
            ...
            <mui.Tab label={`${language.librarySeriesChapters} (${this.props.vm.chapters.items.length})`} disabled={!this.props.vm.chapters.items.length} value={1} />
          </mui.Tabs>
        </mui.Paper>
        <mui.Grid className={this.classes.containerBody}>
          {this.props.vm.showChapters ? <app.SeriesListView vm={this.props.vm.chapters} /> : <mui.Grid>
            <mui.Paper className={this.classes.seriesContent} square={true}>
              <app.SeriesImage className={this.classes.seriesContentImage} imageAsync={() => app.core.context.library.seriesImageAsync(this.props.vm.id)} unreadCount={this.props.vm.chapters.unreadCount} url={this.props.vm.source.url} />

  ...
  render() {
    return (
      <mui.Grid className={this.classes.container}>
        <app.ButtonComponent color="inherit" title={this.props.vm.settings.enableModeRTL ? language.sessionIconNextChapter : language.sessionIconPreviousChapter} onClick={() => this._tryNavigateLeft()}>
          <app.icons.ArrowBack />
        </app.ButtonComponent>
        <app.ButtonComponent color="inherit" title={this.props.vm.settings.enableModeRTL ? language.sessionIconPreviousChapter : language.sessionIconNextChapter} onClick={() => this._tryNavigateRight()}>
